    ...
    <div class="f_l">
        <?php if ($this->_var['intromode'] == 'best'): ?>
         ...
         <?php endif; ?>
          ...
          <a style="display:none" href="javascript:;" onClick="javascript:display_mode('list')"><img src="themes/miqinew/images/display_mode_list<?php if ($this->_var['pager']['display'] == 'list'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['list']; ?>"></a>
          <a   style="display:none" href="javascript:;" onClick="javascript:display_mode('grid')"><img src="themes/miqinew/images/display_mode_grid<?php if ($this->_var['pager']['display'] == 'grid'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['grid']; ?>"></a>
          <a  style="display:none" href="javascript:;" onClick="javascript:display_mode('text')"><img src="themes/miqinew/images/display_mode_text<?php if ($this->_var['pager']['display'] == 'text'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['text']; ?>"></a>&nbsp;&nbsp;
              <select name="sort">
...
?>
                ...
                <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/miqinew/images/bnt_buy_1.gif"></a>
                </li>
                </ul>
                <?php endif; ?>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
