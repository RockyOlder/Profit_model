...
?>
      ...
      <section class="order_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
          <div class="table_box table_box2">
          	<dl class="tx_xianzhi">温馨提示：账户佣金最低提现要求≥50元</dl>
            <dl class="tx_xianzhi">可提现佣金金额：￥<?php if ($this->_var['surplus_amount']): ?><?php echo $this->_var['surplus_amount']; ?><?php else: ?>0<?php endif; ?></dl>
            <dl>
              <dd class="dd1">提现金额：</dd>
			  <dd>
			<input name="amount" type="text" placeholder="提现金额最低：50元" class="dd2">
			</dd>			
            </dl>
            <dl>
              <dd class="dd1">真实姓名： </dd>
              <input name="real_name" type="text" placeholder="输入真实姓名如：张三" value="<?php echo empty($this->_var['real_name']) ? '' : $this->_var['real_name']; ?>" class="dd2">
            </dl>
             <dl>
              <dd class="dd1">开户行： </dd>
              <input name="bank_name" type="text" placeholder="输入提现的银行名称" value="<?php echo empty($this->_var['bank_name']) ? '' : $this->_var['bank_name']; ?>" class="dd2">
            </dl>  
             <dl>
              <dd class="dd1">银行账号： </dd>
              <input name="bank_account" type="text" placeholder="输入提现的银行账号" value="<?php echo empty($this->_var['bank_account']) ? '' : $this->_var['bank_account']; ?>" class="dd2">
            </dl>  
            <dl>
              <dd class="dd1">手机号： </dd>
              <input name="mobile_phone" type="text" placeholder="输入手机号码" value="<?php echo empty($this->_var['mobile_phone']) ? '' : $this->_var['mobile_phone']; ?>" class="dd2">
            </dl>
			<dl>
              <dd class="dd1">备注： </dd>
              <textarea placeholder="会员备注" name="user_note" class="B_blue" style="width:100%; height:70px; font-size:1em;"></textarea>
            </dl> 
			</div>
        </section>
        <div class="blank3"></div>
...
?>
      ...
      <table width="100%" border="1" bordercolor="#999999" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        <tr align="center">
