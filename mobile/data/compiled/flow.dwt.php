...
?>
    ...
    <div class="blank3"> </div>
    <section class="order_box padd1 radius10" style="padding-top:0.1rem;padding-bottom:0.1rem;">
      ...
      <div id="J_allGoods">
        <div class="cont">
          <section class="order on">
            <h6><?php echo $this->_var['lang']['remember_order_number']; ?>: <font style="color:red"><?php echo $this->_var['order']['order_sn']; ?></font></h6>
            <table width="98%" align="center" border="0" cellpadding="15" cellspacing="0" style="border:1px solid #ddd; margin:10px auto;" bgcolor="#FFFFFF">
              <tr>
...
?>
            ...
            <?php endif; ?>
            <p style="text-align:center; margin:20px;"><?php echo $this->_var['order_submit_back']; ?></p>
          </section>
        </div>
      </div>
    </div>
