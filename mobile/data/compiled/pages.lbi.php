      ...
      <div class="pagenav-content">
        <div class="pagenav" id="J_PageNav" style="display:flex; text-align:center;">
          ...
          <div class="pagenav-cur">
            ...
            <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_06080000_1441880415');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_06080000_1441880415']):
?>    
              <option value="<?php echo $this->_var['item_0_06080000_1441880415']; ?>"><?php echo $this->_var['key']; ?></option>
