...
<dl class="user_top">
  ...
  <div class="user_top_list">
    <ul>
      <li> <a href="user.php?act=order_list&status=0"> <i class="icon-card"></i> <span>待支付</span> </a> </li>
      <li> <a href="user.php?act=order_list&status=5&shipping_status=1"> <i class="icon-lowLevel"></i> <span>待收货</span> </a> </li>
      <li> <a href="user.php?act=order_list"><i class="icon-shop"></i> <span>全部订单</span> </a> </li>
    </ul>
  </div>
</dl>
...
<section class="wrap">  
  	<ul class="side-nav"> 
        <li><a href="user.php?act=profile" class="clearfix"><i class="icon-personal"></i><span class="text"><?php echo $this->_var['lang']['label_profile']; ?></span><i class="arrow"></i> </a></li>
        <!--<li><a href="user.php?act=order_list" class="clearfix"><i class="icon-order"></i><span class="text"><?php echo $this->_var['lang']['label_order']; ?></span><i class="arrow"></i> </a></li> -->
        <li><a href="user.php?act=address_list"  class="clearfix"><i class="icon-shop"></i><span class="text"><?php echo $this->_var['lang']['label_address']; ?></span><i class="arrow"></i> </a></li>
        <li><a href="<?php echo $this->_var['wxchdata']['qr_path']; ?>"  class="clearfix"><i class="icon-friends"></i><span class="text">二维码</span><i class="arrow"></i> </a></li>
    	<li><a id="disstroe" href="javascript:void(0)" class="clearfix"><i class="icon-qq"></i><span class="text">联系客服</span><i id="arrow" class="arrow"></i> </a>
        	<div id="disstroe-sub" class="member-nav-sub" style="display: none;">
                <ul class="member-nav-sub-ul">
                    <li id="drpOrder" class="member-nav-sub-li"><a href="tel:<?php echo $this->_var['service_phone']; ?>" class="clearfix"><span class="text">呼叫客服</span><i class="arrow"></i></a></li>
                 <?php $_from = $this->_var['qq']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'im');if (count($_from)):
    foreach ($_from AS $this->_var['im']):
?>
                    <?php if ($this->_var['im']): ?>
                    <li class="member-nav-sub-li" id="shop"><a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $this->_var['im']; ?>&site=qq&menu=yes"><span class="text">QQ客服</span><i class="arrow"></i> </a></li>
                    <?php endif; ?>
...
$(document).ready(function(){
  $("#disstroe").click(function(){
      $("#disstroe-sub").toggle(500);
  ...
  <div class="blank3"></div>
  <ul class="side-user">
      <li> <a href="user.php?act=order_list"> <strong><?php echo $this->_var['info']['order_count']; ?></strong> <span>本月订单</span> </a> </li>
      <li> <a href="user.php?act=point"> <strong><?php echo $this->_var['info']['integral']; ?></strong> <span>积分</span> </a> </li>
      <li> <a href="distribute.php?act=account_detail"> <strong><?php echo $this->_var['info']['surplus']; ?></strong><span>余额</span> </a> </li>
     <!-- <li style="border-right:none;"> <a class="fragment" href="user.php?act=bonus"> <strong><?php echo $this->_var['info']['bonus']; ?></strong><span>红包</span> </a> </li>-->
   </ul>
  <div class="blank3"></div>
<?php if ($this->_var['shishiflag'] == "1"): ?>
 <!-- <div style="  font-size: 15px;">盈家省代推广渠道</div>-->
  <ul class="side-user">
      <li> <a href="distribute.php"> <strong><?php echo $this->_var['all_count']; ?></strong> <span>我的人气</span> </a> </li>
      <li> <a href="#"> <strong>￥<?php if ($this->_var['shishiall']['order_amount']): ?><?php echo $this->_var['shishiall']['order_amount']; ?><?php else: ?>0<?php endif; ?></strong> <span>累计销售</span> </a> </li>
      <li> <a href="#"> <strong>￥<?php if ($this->_var['shishiall']['setmoney']): ?><?php echo $this->_var['shishiall']['setmoney']; ?><?php else: ?>0<?php endif; ?></strong><span>累计佣金</span> </a> </li>
    <!--  <li style="border-right:none;"> <a class="fragment" href="user.php?act=bonus"> <strong><?php echo $this->_var['info']['bonus']; ?></strong><span>红包</span> </a> </li>-->
   </ul>

  <ul class="side-user">
      <li> <a href="#"> <strong><?php echo $this->_var['orderCountStatistical']['order_count']; ?></strong> <span>代理订单</span> </a> </li>
      <li> <a href="#" > <strong>￥<?php echo $this->_var['orderCountStatistical']['goods_count']; ?></strong> <span>代理销售</span> </a> </li>
      <li> <a href="#"> <strong><?php echo $this->_var['orderCountStatistical']['user_count']; ?></strong><span>代理积分</span> </a> </li>
   </ul>
<?php endif; ?>
 <div class="blank3"></div>
  <ul class="side-nav"> 
    <li><a href="user.php?act=logout" class="clearfix"><i class="icon-logout"></i><span class="text">退出登录</span><i class="arrow"></i> </a></li>
  </ul>
...
<section class="wrap message
  ...
  <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
      ...
      <tr>
        <td> <?php echo $this->_var['lang']['order_number']; ?> <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/shishiv5/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
