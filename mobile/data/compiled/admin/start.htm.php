...
<div class="list-index" style="border: 1px solid #CC0000">
...
<!--shishi-wfx start 官方动态 -->
<div class="list-index" style=" height:248px;">

<h6 style="color:red;">实实微分销官方动态</h6>
   <div class="content">
		<script type="text/javascript" src="http://bbs.hanyu168.com/api.php?mod=js&bid=3"></script>
...
<!--shishi-wfx start 授权信息 -->
<div class="list-index">
<table cellspacing='1' cellpadding='3'>
  <tr>
    <th colspan="4" class="group-title"><strong  style="color:red;">授权信息</strong></th>
  </tr>
  <tr>
    <td width="20%">授权类型：</td>
    <td width="30%"><strong style="color:green;">
	<?php if ($this->_var['sv_url'] == $this->_var['shop_url']): ?>
	正式授权
	<?php else: ?>
	未授权
	<?php endif; ?>
    ...
    <td width="20%">授权域名：</td>
    <td width="30%"><strong style="color:green;"><?php echo $this->_var['shop_url']; ?></strong></td>
  </tr>
  <tr>
    <td>实实微分销论坛：</td>
    <td><strong><a href="http://bbs.hanyu168.com/" style="color:green;" target="_blank">http://bbs.hanyu168.com/</a></strong></td>
    <td>技术支持：</td>
    <td><strong><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1141881310&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:1141881310:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a></strong></td>
  </tr>
</table>
</div>
<!--shishi-wfx end  -->
