...
?>
        ...
        <div class="bt_center"><input name="submit" type="submit" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" class="c-btn3"   /></div>
      ...
      <form name="formPassword" action="user.php" method="post" onSubmit="return editPassword()" >
        ...
        <div class="bt_center">
        	<ul>
        	<li><input name="submit" type="submit" class="c-btn3"     value="<?php echo $this->_var['lang']['confirm_edit']; ?>" /></li>
            <li><a href="javascript:history.go(-1)" class="c-btn3" />返回</a></li>
            </ul>
            </div>
      </form>
    </section>
...
?>
    ...
    <section class="wrap bonus_list">
      ...
      <table width="100%" border="1" cellpadding="5" cellspacing="0" class="ectouch_table">
        <tr>
...
?>
    ...
    <section class="wrap order_list">
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
        ...
        <tr>
          <td><span class="order_handler"></span><span class="order_tracking"></span></td>
        </tr>
      </table>
    </section>
...
jQuery(function($){
	...
	if(resultJson.status == 200) { //成功
		...
		resultTable.append("<tr><td style='text-align:center;'>"+ resultJson.message +"</td></tr>");				
	}
})
</script>
    </div>
...
?> 
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
        <tr>
          <td width="27%" align="right"><?php echo $this->_var['lang']['consignee_name']; ?>：</td>
...
?>
          <tr>
            ...
            <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img style="border-radius:0.5em; margin:0;" src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods']['goods_thumb']; ?>" width="60" height="60" /></a></td>
            <td><?php echo $this->_var['goods']['goods_name']; ?></td>
          </tr>
          <tr>
            <td style="border-bottom:1px #CCCCCC dashed">售价：<?php echo $this->_var['goods']['goods_price']; ?>   数量：<?php echo $this->_var['goods']['goods_number']; ?>   小计：<?php echo $this->_var['goods']['subtotal']; ?></td>
          </tr>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </table>
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
        <tr>
          <td bgcolor="#ffffff"> <?php echo $this->_var['lang']['select_payment']; ?>： <?php echo $this->_var['order']['pay_name']; ?>。<br><?php echo $this->_var['lang']['order_amount']; ?>： <strong><?php echo $this->_var['order']['formated_order_amount']; ?></strong><br />
            <?php echo $this->_var['order']['pay_desc']; ?> <?php if ($this->_var['order']['order_amount'] > 0): ?><?php echo $this->_var['order']['pay_online']; ?><?php endif; ?></td>
        </tr>
        <tr>
...
?>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
        ...
        <tr>
          <td width="19%" align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['shipping']; ?>：</td>
		...
		<?php if ($this->_var['order']['invoice_no']): ?>
            <p class="order_genzong"><span><a href="user.php?act=order_tracking&order_id=<?php echo $this->_var['order']['order_id']; ?>" class="c-btn3">订单跟踪</a></span></p>
        <?php endif; ?>
      </section>
...
?>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
        ...
        <tr>
          <td align="right"><?php echo $this->_var['lang']['detailed_address']; ?>：</td>
          <td align="left"><?php echo $this->_var['consignee']['address_message']; ?>--<?php echo htmlspecialchars($this->_var['consignee']['address']); ?>
      ...
      <div class="bt_center">
       <ul>
       <li><a href="user.php?act=act_edit_address&flag=display" class="c-btn3"><?php echo $this->_var['lang']['add_address']; ?></a></li>
       <li><a href="javascript:history.go(-1)" class="c-btn3">返回</a></li>
       </ul>
       </div>
    </section>
...
?>
    ...
    <section class="wrap">
      ...
      <form action="user.php" method="post" name="theForm" onsubmit="return checkConsignee(this)">
        ...
        <input name="city_name"  type="hidden" id="city_name"/>
        <input name="district_name"  type="hidden" id="district_name" />
        <table width="100%" border="0" cellpadding="5" cellspacing="0"  >
          <tr>
          	<td width="70" id="xx">收货人：</td>
          ...
          <tr>
            ...
            <td align="left" >
               <!--<select name="country" id="proince_message" onchange="region.changed(this, 1, 'selProvinces')">
...
?>
              ...
              <select name="district" id="selDistricts"onchange="region.district(this, 4, 'selProvinces')" <?php if (! $this->_var['district_list']): ?>style="display:none"<?php endif; ?>>
