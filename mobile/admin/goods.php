...
include_once(ROOT_PATH . '/include/cls_image_shishi.php');
...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    if ($is_add)
    {
        ...
        $goods = array(
            ...
            'goods_type'    => 0,       // 商品类型
            'shop_price'    => 0,
			'sales_volume'  => 0,  //shishi-wfx 添加自定义销量
            'promote_price' => 0,
            'market_price'  => 0,
            'integral'      => 0,
...
//var_dump($img_list);exit;
    ...
    $smarty->assign('gd', gd_version_shishi());
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $sales_volume = !empty($_POST['sales_volume']) ? $_POST['sales_volume'] : 0;
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    "cat_id, brand_id, shop_price, sales_volume_base, market_price, is_promote, promote_price, " .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price','$sales_volume', '$market_price', '$is_promote','$promote_price', ".
    ...
    else
    {
        ...
        $sql = "UPDATE " . $ecs->table('goods') . " SET " .
				...
				"sales_volume_base = '$sales_volume', " .
...
elseif ($_REQUEST['act'] == 'product_list')
{
    ...
    /* 取出商品信息 */
    $sql = "SELECT goods_sn, goods_name, goods_type, shop_price, sales_volume_base FROM " . $ecs->table('goods') . " WHERE goods_id = '$goods_id'";
    $goods = $db->getRow($sql);
    if (empty($goods))
    {
    ...
    $smarty->assign('sales', sprintf($_LANG['good_sales_volume'], $goods['sales_volume']));
