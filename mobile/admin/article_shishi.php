...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('action_link',  array('text' => "添加推广单品页面", 'href' => 'article_shishi.php?act=add'));
    ...
    assign_query_info();
    $smarty->display('article_list_shishi.htm');
}
...
if ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('action_link', array('text' => "查看正在推广的单品", 'href' => 'article_shishi.php?act=list'));
    $smarty->assign('form_action', 'insert');

    assign_query_info();
    $smarty->display('article_info_shishi.htm');
}
...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $link[1]['href'] = 'article_shishi.php?act=list';
...
if ($_REQUEST['act'] =='update')
{
    ...
    if ($exc->edit("title='$_POST[title]', cat_id='$_POST[article_cat]', article_type='$_POST[article_type]', is_open='$_POST[is_open]', author='$_POST[author]', author_email='$_POST[author_email]', keywords ='$_POST[keywords]', file_url ='$file_url', open_type='$open_type', content='$_POST[FCKeditor1]', link='$_POST[link_url]', description = '$_POST[description]'", $_POST['id']))
    {
        ...
        $link[0]['href'] = 'article_shishi.php?act=list&' . list_link_postfix();
